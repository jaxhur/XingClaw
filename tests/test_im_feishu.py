...
class FeishuAdapterTests(unittest.TestCase):
    ...
    def test_reply_http_error_includes_feishu_body(self) -> None:
        class FakeResponse:
            status_code = 400
            text = '{"code":99991663,"msg":"permission denied"}'
        ...
        with self.assertRaisesRegex(RuntimeError, "permission denied"):
            adapter._reply_message(FakeHttpx, {}, "om_1", "text", json.dumps({"text": "hi"}))
